(function(){
  ...
  // 2026-09-15：应用户要求，启蒙英语放入精选第一位。
  var featuredOrder=['english','ai','black-and-white','concurrency','meta','netflix','native','longtail'];
  var topics=[
    ...
    {topic:'english',category:'english',date:'2026-09-15',order:9,compact:true,href:'english/index.html',overline:'英语 · 亲子启蒙',title:'启蒙英语 · English Garden',summary:'给孩子的英语花园：点一点、听一听，送彩色小动物回家。亲子共玩，每次 10–15 分钟。',meta:['2 个玩法','38 只动物'],art:'<g stroke="currentColor" stroke-width="3" fill="none"><rect x="52" y="42" width="158" height="92" rx="26"/><path d="m92 134-10 30 34-30"/><rect x="252" y="84" width="128" height="72" rx="22"/><path d="m344 156 10 26-30-26"/></g><g fill="currentColor"><circle cx="98" cy="88" r="7"/><circle cx="131" cy="88" r="7"/><circle cx="164" cy="88" r="7"/></g><g fill="currentColor" opacity=".45"><circle cx="300" cy="120" r="5"/><circle cx="326" cy="120" r="5"/><circle cx="352" cy="120" r="5"/></g><g fill="currentColor" opacity=".55"><circle cx="438" cy="58" r="8"/><circle cx="470" cy="106" r="5"/><circle cx="428" cy="150" r="6"/><path d="m472 40 9 16-18 1z"/></g>'}
  ];
  ...
  shell.innerHTML='<button class="home-mobile-menu" type="button" aria-label="打开花园导航" aria-expanded="false">'+icon('<path d="M4 7h16M4 12h16M4 17h16"/>')+'</button><div class="home-nav-backdrop"></div>'+ 
    ...
    '<div class="home-nav-group"><p class="home-nav-label">知识分类</p>'+navItem('english','英语','1','<path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>')+navItem('tech','技术','3','<circle cx="12" cy="12" r="3"/><path d="M12 3v3M12 18v3M3 12h3M18 12h3M5.6 5.6l2.1 2.1M16.3 16.3l2.1 2.1M18.4 5.6l-2.1 2.1M7.7 16.3l-2.1 2.1"/>')+navItem('think','思维','4','<path d="M9 18h6M10 21h4M12 3a7 7 0 0 0-4 12.7c.6.5 1 1.2 1 2V18h6v-.3c0-.8.4-1.5 1-2A7 7 0 0 0 12 3z"/>')+navItem('photo','摄影','1','<rect x="3" y="6" width="18" height="14" rx="2"/><circle cx="12" cy="13" r="4"/><path d="M8 6 9.5 3h5L16 6"/>')+'</div>'+
  ...
  var labels={featured:['CURATED COLLECTION · '+featuredOrder.length+' TOPICS','精选专题'],all:['All topics','全部专题'],english:['English','英语 · 启蒙英语'],tech:['Technology','技术专题'],think:['Thinking','思维专题'],photo:['Photography','摄影专题'],recent:['Recently tended','最近更新']};
